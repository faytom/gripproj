...
int epb_pack_base_request(BaseRequest *request, uint8 *buf, int buf_len)
{
	Epb epb;
...
BaseResponse *epb_unpack_base_response(const uint8 *buf, int buf_len)
{
	Epb epb;
...
BasePush *epb_unpack_base_push(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
int epb_pack_auth_request(AuthRequest *request, uint8 *buf, int buf_len)
{
	Epb epb;
	epb_pack_init(&epb, buf, buf_len);
...
AuthResponse *epb_unpack_auth_response(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
int epb_pack_init_request(InitRequest *request, uint8 *buf, int buf_len)
{
	Epb epb;
	epb_pack_init(&epb, buf, buf_len);
...
InitResponse *epb_unpack_init_response(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
int epb_pack_send_data_request(SendDataRequest *request, uint8 *buf, int buf_len)
{
	Epb epb;
	epb_pack_init(&epb, buf, buf_len);
...
SendDataResponse *epb_unpack_send_data_response(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
RecvDataPush *epb_unpack_recv_data_push(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
SwitchViewPush *epb_unpack_switch_view_push(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
...
SwitchBackgroudPush *epb_unpack_switch_backgroud_push(const uint8 *buf, int buf_len)
{
	Epb epb;
	epb_unpack_init(&epb, buf, buf_len);
