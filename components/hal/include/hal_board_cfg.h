...
#define HAL_STATE_LED4()          (LED3_POLARITY (LED4_SBIT))
#define HAL_STATE_LED5()          (LED3_POLARITY (LED5_SBIT))
#define HAL_STATE_MOTOR()         (LED3_POLARITY (MOTOR_SBIT))    
